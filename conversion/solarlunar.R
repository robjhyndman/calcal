...
ephemeris_correction <- function(tee) {
  ...
  if (2051 <= year && year <= 2150) {
    ...
    y1700 <- year - 1700
    (1 / 86400) *
      poly(y1700, c(8.118780842, -0.005092142, 0.003336121, -0.0000266484))
...
aberration <- function(tee) {
  ...
  -deg(0.005575) +
    deg(0.0000974) * cos_degrees(deg(177.63) + deg(35999.01848) * c)
}
...
nth_new_moon <- function(n) {
  ...
  extra <- 0.000325 *
    sin_degrees(poly(c, deg(c(299.77, 132.8475848, -0.009173))))
